...
out = cv2.VideoWriter('D:/sign-language-recognition-project/code/outputs/asl.mp4', cv2.VideoWriter_fourcc(*'mp4v'), 30, (frame_width,frame_height))
...
while(cap.isOpened()):
    ...
    if lb.classes_[preds] == "W":
        lb.classes_[preds] = "BEVO!!"
        cv2.putText(frame, lb.classes_[preds], (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.9, (0, 0, 255), 2)
    elif lb.classes_[preds] == "L":
        lb.classes_[preds] = "Love"
        cv2.putText(frame, lb.classes_[preds], (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.9, (0, 0, 255), 2)
    elif lb.classes_[preds] == "V":
        lb.classes_[preds] = "PEACE"
        cv2.putText(frame, lb.classes_[preds], (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.9, (0, 0, 255), 2)
    elif lb.classes_[preds] == "O":
        lb.classes_[preds] = "OK!"
        cv2.putText(frame, lb.classes_[preds], (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.9, (0, 0, 255), 2)
    elif lb.classes_[preds] == "U":
        lb.classes_[preds] = "UP"
        cv2.putText(frame, lb.classes_[preds], (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.9, (0, 0, 255), 2)
    elif lb.classes_[preds] == "Q" or lb.classes_[preds] == "Z":
        lb.classes_[preds] = "DOWN"
        cv2.putText(frame, lb.classes_[preds], (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.9, (0, 0, 255), 2)
    else:
        cv2.putText(frame, lb.classes_[preds], (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.9, (0, 0, 255), 2)
