...
dir_paths = os.listdir('D:/sign-language-recognition-project/code/input/asl_alphabet_train/asl_alphabet_train')
dir_paths.sort()
root_path = 'D:/sign-language-recognition-project/code/input/asl_alphabet_train/asl_alphabet_train'
