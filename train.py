...
df = pd.read_csv('D:/sign-language-recognition-project/code/input/data.csv')
...
plt.ylabel('Accuracy')
plt.legend()
plt.savefig('D:/sign-language-recognition-project/code/outputs/accuracy.png')
plt.show()
...
plt.ylabel('Loss')
plt.legend()
plt.savefig('D:/sign-language-recognition-project/code/outputs/loss.png')
plt.show()
# save the model to disk
print('Saving model...')
torch.save(model.state_dict(), 'D:/sign-language-recognition-project/code/outputs/model.pth')